...
- {id: BUS_CLK.outFreq, value: 25 MHz}
- {id: CLKOUT.outFreq, value: 48 MHz}
- {id: CMP0_CLK.outFreq, value: 25 MHz}
- {id: CORE_CLK.outFreq, value: 50 MHz}
- {id: CRC0_CLK.outFreq, value: 25 MHz}
- {id: DMA0_CLK.outFreq, value: 50 MHz}
- {id: DMAMUX0_CLK.outFreq, value: 25 MHz}
- {id: EIM0_CLK.outFreq, value: 50 MHz}
- {id: ERM0_CLK.outFreq, value: 50 MHz}
- {id: EWM0_CLK.outFreq, value: 25 MHz}
- {id: FIRCDIV1_CLK.outFreq, value: 48 MHz}
- {id: FIRCDIV2_CLK.outFreq, value: 48 MHz}
- {id: FLASH_CLK.outFreq, value: 12.5 MHz}
- {id: FLEXCAN0_CLK.outFreq, value: 50 MHz}
- {id: FLEXCAN1_CLK.outFreq, value: 50 MHz}
- {id: FLEXCAN2_CLK.outFreq, value: 50 MHz}
- {id: FTFC0_CLK.outFreq, value: 12.5 MHz}
...
- {id: MPU0_CLK.outFreq, value: 50 MHz}
- {id: MSCM0_CLK.outFreq, value: 50 MHz}
- {id: PDB0_CLK.outFreq, value: 50 MHz}
- {id: PDB1_CLK.outFreq, value: 50 MHz}
- {id: PORTA_CLK.outFreq, value: 25 MHz}
- {id: PORTB_CLK.outFreq, value: 25 MHz}
- {id: PORTC_CLK.outFreq, value: 25 MHz}
- {id: PORTD_CLK.outFreq, value: 25 MHz}
- {id: PORTE_CLK.outFreq, value: 25 MHz}
- {id: RTC0_CLK.outFreq, value: 25 MHz}
...
- {id: SOSCDIV1_CLK.outFreq, value: 10 MHz}
- {id: SOSCDIV2_CLK.outFreq, value: 10 MHz}
- {id: SPLLDIV1_CLK.outFreq, value: 100 MHz}
- {id: SPLLDIV2_CLK.outFreq, value: 100 MHz}
- {id: SPLL_CLK_OUT.outFreq, value: 100 MHz}
- {id: SYS_CLK.outFreq, value: 50 MHz}
- {id: TRACE_CLK.outFreq, value: 50 MHz}
settings:
...
- {id: SCG.SOSCDIV1.scale, value: '4', locked: true}
- {id: SCG.SOSCDIV2.scale, value: '4', locked: true}
...
sources:
- {id: RTC.RTC_CLK_EXT_IN.outFreq, value: 32.768 kHz}
- {id: SCG.SOSC.outFreq, value: 40 MHz, enabled: true}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
...
clock_manager_user_config_t clockMan1_InitConfig0 = {
    .scgConfig =
    {
        ...
        {
            .initialize = true,
            .freq = 40000000U,                    /* System Oscillator frequency: 40000000Hz */
            ...
            .div1 = SCG_ASYNC_CLOCK_DIV_BY_4,     /* System OSC Clock Divider 1: divided by 4 */
            .div2 = SCG_ASYNC_CLOCK_DIV_BY_4,     /* System OSC Clock Divider 3: divided by 4 */
        },
        .spllConfig =
        {
            .initialize = true,
            ...
            .locked = false,                      /* unlocked */
            .prediv = (uint8_t)SCG_SPLL_CLOCK_PREDIV_BY_4,/* Divided by 4 */
