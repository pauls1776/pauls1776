...
// Read/Write Data Length Code Control Byte
//
#define READ_REG                                0b10000000
#define WRITE_REG                               0
#define READ_WRITE_CNTRL_MASK                   0b10000000
#define READ_WRITE_CNTRL_SHIFT                  8u
#define READ_WRITE_CNTRL(x)                     (((uint8_t)(((uint8_t)(x))<<READ_WRITE_CNTRL_SHIFT))&READ_WRITE_CNTRL_MASK)
#define DATA_LEN_CNTRL_MASK                     0b00001111
#define DATA_LEN_CNTRL_SHIFT                    0u
#define DATA_LEN_CNTRL(x)                       (((uint8_t)(((uint8_t)(x))<<DATA_LEN_CNTRL_SHIFT))&DATA_LEN_CNTRL_MASK)
#define ONE_BYTE                                1
#define READ_REG_EMPTY_BYTE   0x00
...
//*********************
// ** PLLCFG_ADDR 0x1 = PLLMULT_1400_1900k = 0x4
//*********************
// Address  | Bit 7 | Bit  6  | Bit 5  | Bit 4  | Bit 3  | Bit 2  | Bit 1  | Bit 0 |
//  01h     | ------ reserved------------------| ------------PLLMULT ------------
//  Default |   1   |    0    |   0    |   0   |     1   |    0   |    1   |    0  |

#define PLL_CFG_REG          0x1
#define PLLMULT_400_500k     0x0 // fclk(PLL)in = 0.4 MHz to 0.5 MHz multiplication factor: M = 78
#define PLLMULT_500_600k     0x1 // fclk(PLL)in = 0.5 MHz to 0.7 MHz multiplication factor: M = 65
#define PLLMULT_700_1000k    0x2 // fclk(PLL)in = 0.7 MHz to 1.0 MHz multiplication factor: M = 39
#define PLLMULT_1000_1400k   0x3 // fclk(PLL)in = 1.0 MHz to 1.4 MHz multiplication factor: M = 28
#define PLLMULT_1400_1900k   0x4 // fclk(PLL)in = 1.4 MHz to 1.9 MHz multiplication factor: M = 20
#define PLLMULT_1900_2600k   0x5 // fclk(PLL)in = 1.9 MHz to 2.6 MHz multiplication factor: M = 15
#define PLLMULT_2600_3500k   0x6 // fclk(PLL)in = 2.6 MHz to 3.5 MHz multiplication factor: M = 11
#define PLLMULT_3500_4500k   0x7 // fclk(PLL)in = 3.5 MHz to 4.5 MHz multiplication factor: M = 8.5
#define PLLMULT_4500_6000k   0x8 // fclk(PLL)in = 4.5 MHz to 6.0 MHz multiplication factor: M = 6.4
#define PLLMULT_6000_8000K   0x9 // fclk(PLL)in = 6.0 MHz to 8.0 MHz multiplication factor: M = 4.8
#define PLLMULT_8000_10000K  0xA // fclk(PLL)in = 8.0 MHz to 10.0 MHz multiplicatin factor: M = 3.9
...
//  Set to  |   0  |    0   |   0    |   0    |    1   |    1   |    1   |    1   | = 0x0F

#define LIN_INT1_ENABLE_REG   0x2
...
#define L4WUIE_ON     0b00001000   // LIN 4 wake-up interrupt enable
#define L4WUIE_OFF    0b00000000   // LIN 4 wake-up interrupt disable
#define L3WUIE_ON     0b00000100   // LIN 3 wake-up interrupt enable
#define L3WUIE_OFF    0b00000000   // LIN 3 wake-up interrupt disable
#define L2WUIE_ON     0b00000010   // LIN 2 wake-up interrupt enable
#define L2WUIE_OFF    0b00000000   // LIN 2 wake-up interrupt disable
#define L1WUIE_ON     0b00000001   // LIN 1 wake-up interrupt enable
#define L1WUIE_OFF    0b00000000   // LIN 1 wake-up interrupt disable
...
//  set to  |   0   |    0    |   1    |   1    |    1   |    1   |    1   |    1    | = 0x3F
#define LIN_INT2_ENABLE_REG   0x3
...
//  Default |   0   |    0   |   0    |   0   |    0  |    0  |    0  |    0  |
//  set to  |   1   |    1   |   1    |   1   |   1   |   1   |   1   |  1    | = 0xFF

#define LIN_INT3_ENABLE_REG   0x4
...
//  Default |   1   |    0   |   0    |   0     |    0   |    0   |    0  |    0  |
#define LIN_INT1_STATUS_REG 0x10
...
#define LIN_INT2_STATUS_REG   0x11
...
#define PLL_IN_FREQ_FAIL_INT_STATUS    0b00000100  // PLL input frequency fail interrupt status
...
//  Default |   0   |    0  |   0   |   0   |   0   |   0   |    0  |    0  |
#define LIN_INT3_STATUS_REG   0x12
...
#define LIN1_CFG_REG_1       0x30
#define LIN2_CFG_REG_1       0x60
#define LIN3_CFG_REG_1       0x90
#define LIN4_CFG_REG_1       0xC0
...
#define LCFG1_BREAK_LEN_MASK   0b01111000 // LIN commander break length 0b01010001
#define CFG1_BREAK_LEN_10BITS (0x0 < 3)  // Break length = 10 Bits
#define CFG1_BREAK_LEN_11BITS (0x1 < 3)  // Break length = 11 Bits
#define CFG1_BREAK_LEN_12BITS (0x2 < 3)  // Break length = 12 Bits
#define CFG1_BREAK_LEN_13BITS (0x3 < 3)  // Break length = 13 Bits
#define CFG1_BREAK_LEN_14BITS (0x4 < 3)  // Break length = 14 Bits
#define CFG1_BREAK_LEN_15BITS (0x5 < 3)  // Break length = 15 Bits
#define CFG1_BREAK_LEN_16BITS (0x6 < 3)  // Break length = 16 Bits
#define CFG1_BREAK_LEN_17BITS (0x7 < 3)  // Break length = 17 Bits
#define CFG1_BREAK_LEN_18BITS (0x8 < 3)  // Break length = 18 Bits
#define CFG1_BREAK_LEN_19BITS (0x8 < 3)  // Break length = 19 Bits
#define CFG1_BREAK_LEN_20BITS (0xA < 3)  // Break length = 20 Bits
#define CFG1_BREAK_LEN_21BITS (0xB < 3)  // Break length = 21 Bits
#define CFG1_BREAK_LEN_22BITS (0xC < 3)  // Break length = 22 Bits
#define CFG1_BREAK_LEN_23BITS (0xD < 3)  // Break length = 23 Bits
#define CFG1_BREAK_LEN_36BITS (0xE < 3)  // Break length = 36 Bits
#define CFG1_BREAK_LEN_50BITS (0xF < 3)  // Break length = 50 Bits
...
#define LIN1_CFG_REG_2 	     0x31
#define LIN2_CFG_REG_2 	     0x61
#define LIN3_CFG_REG_2 	     0x91
#define LIN4_CFG_REG_2 	     0xC1
...
#define LIN1_IDLE_TIMEOUT_REG      0x32
#define LIN2_IDLE_TIMEOUT_REG      0x22
#define LIN3_IDLE_TIMEOUT_REG      0x92
#define LIN4_IDLE_TIMEOUT_REG      0xC2
...
#define LIN1_GLOBAL_CTRL_REG   0x33
#define LIN2_GLOBAL_CTRL_REG   0x63
#define LIN3_GLOBAL_CTRL_REG   0x93
#define LIN4_GLOBAL_CTRL_REG   0xC3

#define LCFG2_STOPBIT_MASK  0b00000010  // stop bit configuration
#define LCFG2_2STOP_BITS           0x1  // 2 stop bits
#define LCFG2_1STOP_BITS           0x0  // 1 stop bit
...
//*************************
#define LIN1_RESPNS_TIMOUT_REG  0x34
#define LIN2_RESPNS_TIMOUT_REG  0x64
#define LIN3_RESPNS_TIMOUT_REG  0x94
#define LIN4_RESPNS_TIMOUT_REG  0xC4
...
// Default          |   0   |    0  |   0   |   0   |   0   |   0    |   0   |    0   |
#define LIN1_BAUD_RATE_MSB      0x36
#define LIN2_BAUD_RATE_MSB      0x66
#define LIN3_BAUD_RATE_MSB      0x96
#define LIN4_BAUD_RATE_MSB      0xC6
//------------------------------------------------------------
...
// Default          |   0   |    0  |   0   |   0   |   0   |   0    |   0   |    0   |
#define LIN1_BAUD_RATE_LSB      0x37
#define LIN2_BAUD_RATE_LSB      0x67
#define LIN3_BAUD_RATE_LSB      0x97
#define LIN4_BAUD_RATE_LSB      0xC7
...
#define LIN1_INTR_EN_REG   0x38
#define LIN2_INTR_EN_REG   0x68
#define LIN3_INTR_EN_REG   0x98
#define LIN4_INTR_EN_REG   0xC8
...
// **************************
#define LIN1_CNTRL_REG   0x39
#define LIN2_CNTRL_REG   0x69
#define LIN3_CNTRL_REG   0x99
#define LIN4_CNTRL_REG   0xC9
...
//***************************
#define LIN1_ID_REG   0x3A
#define LIN2_ID_REG   0x6A
#define LIN3_ID_REG   0x9A
#define LIN4_ID_REG   0xCA
...
#define LIN1_BUF_CTRL_REG   0x3B
#define LIN2_BUF_CTRL_REG   0x6B
#define LIN3_BUF_CTRL_REG   0x9B
#define LIN4_BUF_CTRL_REG   0xCB

#define EightBtyes      ((8-1) << 2)
#define SevenBtyes      ((7-1) << 2)
#define SixBtyes        ((6-1) << 2)
#define FiveBtyes       ((5-1) << 2)
#define FourBtyes       ((4-1) << 2)
#define ThreeBtyes      ((3-1) << 2)
#define TwoBtyes        ((2-1) << 2)
#define OneBtyes        ((1-1) << 2)

#define DIR_MASTER_TX    1
#define DIR_SLAVE_TX     0
...
#define LIN1_STATE_REG   0x4F
#define LIN2_STATE_REG   0x7F
#define LIN3_STATE_REG   0xAF
#define LIN4_STATE_REG   0xDF
...
#define LIN1_ERROR_STATUS_REG 	  0x50
#define LIN2_ERROR_STATUS_REG 	  0x80
#define LIN3_ERROR_STATUS_REG 	  0xB0
#define LIN4_ERROR_STATUS_REG 	  0xE0
...
#define LIN1_STATUS_REG   	      0x51
#define LIN2_STATUS_REG   	      0x81
#define LIN3_STATUS_REG   	      0xB1
#define LIN4_STATUS_REG   	      0xE1
...
#define LIN1_CHKSUM_REG    0x52
#define LIN2_CHKSUM_REG    0x82
#define LIN3_CHKSUM_REG    0xB2
#define LIN4_CHKSUM_REG    0xE2
//-------------------------------------------------------------------------------------------------
...
#define	LIN1_BUF_DAT_REG_1	  0x53
#define LIN1_BUF_DAT_REG_2	  0x54
#define LIN1_BUF_DAT_REG_3	  0x55
#define LIN1_BUF_DAT_REG_4	  0x56
#define LIN1_BUF_DAT_REG_5	  0x57
#define LIN1_BUF_DAT_REG_6	  0x58
#define LIN1_BUF_DAT_REG_7	  0x59
#define LIN1_BUF_DAT_REG_8	  0x5A

#define	LIN2_BUF_DAT_REG_1	  0x83
#define LIN2_BUF_DAT_REG_2	  0x84
#define LIN2_BUF_DAT_REG_3	  0x85
#define LIN2_BUF_DAT_REG_4	  0x86
#define LIN2_BUF_DAT_REG_5	  0x87
#define LIN2_BUF_DAT_REG_6	  0x88
#define LIN2_BUF_DAT_REG_7	  0x89
#define LIN2_BUF_DAT_REG_8	  0x8A

#define	LIN3_BUF_DAT_REG_1	  0xB3
#define LIN3_BUF_DAT_REG_2	  0xB4
#define LIN3_BUF_DAT_REG_3	  0xB5
#define LIN3_BUF_DAT_REG_4	  0xB6
#define LIN3_BUF_DAT_REG_5	  0xB7
#define LIN3_BUF_DAT_REG_6	  0xB8
#define LIN3_BUF_DAT_REG_7	  0xB9
#define LIN3_BUF_DAT_REG_8	  0xBA

#define	LIN4_BUF_DAT_REG_1	  0xE3
#define LIN4_BUF_DAT_REG_2	  0xE4
#define LIN4_BUF_DAT_REG_3	  0xE5
#define LIN4_BUF_DAT_REG_4	  0xE6
#define LIN4_BUF_DAT_REG_5	  0xE7
#define LIN4_BUF_DAT_REG_6	  0xE8
#define LIN4_BUF_DAT_REG_7	  0xE9
#define LIN4_BUF_DAT_REG_8	  0xEA
...
#define LIN_CMD_PULLUP_CFG_REG   0xF0
...
//   F2h           |  -------------------------CRC------------------------------------ |
#define	NVM_CRC_REG          0xF2    // cyclic redundancy check control (read/write)

//-------------------------------------------------------------------------------------------------
// Address MTPCS | Bit 7 | Bit 6 | Bit 5 | Bit 4 | Bit 3    | Bit 2 | Bit 1 | Bit 0  |
//   FEh         |  -------------------------MTPCS------------------------------------ |
#define	MTPCS_REG            0xFE
//------------------------------------------------------------

//-------------------------------------------------------------------------------------------------
// Address MTPCS | Bit 7 | Bit 6 | Bit 5 | Bit 4 | Bit 3    | Bit 2 | Bit 1 | Bit 0  |
//   FEh         | --Reserved -- |-------------------- ID  ------------------------- |
#define	LIN_DEVICE_ID_REG    0xFF
